...
class CheckInOccupiedScreen extends StatefulWidget {
  const CheckInOccupiedScreen({super.key});

  @override
  State<CheckInOccupiedScreen> createState() => _CheckInOccupiedScreenState();
}

class _CheckInOccupiedScreenState extends State<CheckInOccupiedScreen> {
