...
class CheckInVacantScreen extends StatefulWidget {
  @override
  State<CheckInVacantScreen> createState() => _CheckInVacantScreenState();
}

class _CheckInVacantScreenState extends State<CheckInVacantScreen> {
